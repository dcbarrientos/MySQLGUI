...
//TODO: Este panel es para diseño de interfaz. Nadie lo debería usar. Borrar al final.
public class PruebaPanel extends JPanel {
	...
	private void initComponents() {
		...
		columnsPanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Index columns",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));

		optionsPanel = new JPanel();
		optionsPanel
				.setBorder(new TitledBorder(null, "Index options", TitledBorder.LEADING, TitledBorder.TOP, null, null));
				...
				.setHorizontalGroup(
						groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup().addContainerGap()
										...
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(optionsPanel,
		...
		gl_optionsPanel.setHorizontalGroup(gl_optionsPanel.createParallelGroup(Alignment.LEADING).addGroup(
				Alignment.TRAILING,
				gl_optionsPanel.createSequentialGroup().addGroup(gl_optionsPanel.createParallelGroup(Alignment.TRAILING)
								...
								.addGroup(gl_optionsPanel.createParallelGroup(Alignment.TRAILING)
										.addGroup(gl_optionsPanel.createSequentialGroup()
												.addGroup(gl_optionsPanel.createParallelGroup(Alignment.LEADING)
														.addComponent(lblStorageType).addComponent(lblKeyBlockSize))
												.addPreferredGap(ComponentPlacement.RELATED))
						...
						.addContainerGap()));
		gl_optionsPanel.setVerticalGroup(gl_optionsPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_optionsPanel
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_optionsPanel
						.createParallelGroup(Alignment.BASELINE).addComponent(lblStorageType).addComponent(comboBox,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_optionsPanel
						.createParallelGroup(Alignment.BASELINE).addComponent(lblKeyBlockSize).addComponent(textField,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
